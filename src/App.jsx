    ...
    <div className="bg-white min-h-screen">
      ...
      <div className="max-w-lg lg:max-w-7xl mx-auto lg:grid grid-cols-2 bg-gray-100 rounded-lg overflow-hidden">
        <div className="relative block h-96 rounded-lg rounded-r-none overflow-hidden ">
          <img src={hero} alt="" className="lg:absolute w-full h-full object-cover inset-0 rounded-md lg:rounded-none shadow-xl" />
        </div>
        <div className="p-12 flex items-center justify-center">
          ...
          <p className="mt-4 text-gray-600">
            ...
            cupiditate, harum voluptatibus ipsum, nisi placeat quo perspiciatis
            cumque alias veritatis vel voluptates amet. Facilis itaque fugit
            possimus quo perspiciatis quia.
          </p>
          <a
            href=""
            className="bg-indigo-700 px-6 py-3 inline-block mt-5 text-white uppercase tracking-wide font-semibold  text-sm rounded-md shadow-xl"
          >
            Book your scape
          </a>
          </div>
